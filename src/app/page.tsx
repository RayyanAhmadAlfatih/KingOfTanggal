...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="m-3 bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="flex justify-center py-6">
          <a className="text-blue-300 font-medium text-sm" href="https://www.linkedin.com/in/aulia-sabri-a339711a3/">&copy; auliasabri.io</a>
        </div>
      </div>
    </div>
  )
